		...
		<div class="content" style="margin-top: 5vh">
			<div class="inicio">
				<div class="images">
					...
					<div class="add-photo">,bolo_laranja(1).png,bolo_laranja.png</div>
					<i class="fa-solid fa-chevron-right"></i>
				</div>
				<div class="receipt-info">
					<div class="title">Bolo de Laranja</div>
			...
			<div class="ingredientes">
				...
				<div id="ingrs">
					<div class="ingrs">,4 ovos,2 xícaras (chá) de açúcar,1 xícara (chá) de óleo,suco de 2 laranjas,casca de 1 laranja,2 xícaras (chá) de farinha de trigo,1 colher (sopa) de fermento</div>
			...
			<div class="modo-de-preparo">
				...
				<div id="preparos">
					<div class="preparo">/Bata no liquidificador os ovos, o açúcar, o óleo, o suco e a casca da laranja./Passe para uma tigela e acrescente a farinha de trigo e o fermento./Leve para assar em uma forma com furo central, untada e enfarinhada, por mais ou menos 30 minutos./Desenforme o bolo e molhe com suco de laranja.</div>
