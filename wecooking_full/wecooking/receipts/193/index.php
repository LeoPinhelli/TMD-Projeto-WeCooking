		...
		<div class="content" style="margin-top: 5vh">
			<div class="inicio">
				<div class="images">
					...
					<div class="add-photo">,torta1.png</div>
					<i class="fa-solid fa-chevron-right"></i>
				</div>
				<div class="receipt-info">
					<div class="title">Tiago</div>
					<div class="tempo">Tempo de preparo: 9 minutos</div>
			...
			<div class="ingredientes">
				...
				<div id="ingrs">
					<div class="ingrs">,Chocolate,2 colheres (sopa) de óleo,1 ovo inteiro</div>
			...
			<div class="modo-de-preparo">
				...
				<div id="preparos">
					<div class="preparo">/Misture todos os ingredientes, e quando ela estiver no ponto, forre um pirex de médio a grande (os mais fundos são melhores). /cozinhe/Quando dourar, está pronta (a massa fica fina, então cuidado para não deixar queimar). </div>
