		...
		<div class="content" style="margin-top: 5vh">
			<div class="inicio">
				<div class="images">
					...
					<div class="add-photo">,bolo_limao(1).png,bolo_limao.png</div>
					<i class="fa-solid fa-chevron-right"></i>
				</div>
				<div class="receipt-info">
					<div class="title">Bolo de Limão</div>
			...
			<div class="ingredientes">
				...
				<div id="ingrs">
					<div class="ingrs">,4 ovos,1/2 copo de óleo,2 copos de açúcar não muito cheios,1 copo de leite,1 caixa de gelatina de limão,2 xícaras de farinha de trigo,1 colher de sopa de fermento em pó</div>
					<div class="ingrs-cover">,1 lata de leite condensado,suco de 3 limões</div>
			...
			<div class="modo-de-preparo">
				...
				<div id="preparos">
					<div class="preparo">/Bata no liquidificador os ovos inteiros, o óleo e o açúcar (bem batidos)./Coloque a gelatina e continue batendo até dissolver./Despeje em uma tigela e acrescente a farinha e o fermento em pó, mexendo sempre, colocando o leite./Coloque em assadeira untada e polvilhada com farinha./Depois de assado e ainda quente, fure com o garfo.</div>
					<div class="preparo-cover">/Bata no liquidificador ou na mão o leite condensado com suco de 3 limões até formar uma cobertura homogênea./Cubra o bolo quando o mesmo estiver frio.</div>
