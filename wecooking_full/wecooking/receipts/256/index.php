		...
		<div class="content" style="margin-top: 5vh">
			<div class="inicio">
				<div class="images">
					...
					<div class="add-photo">,bolo_milho(1).png,bolo_milho.png</div>
					<i class="fa-solid fa-chevron-right"></i>
				</div>
				<div class="receipt-info">
					<div class="title">Bolo de Milho</div>
					<div class="tempo">Tempo de preparo: 50 minutos</div>
			...
			<div class="ingredientes">
				...
				<div id="ingrs">
					<div class="ingrs">,1 lata de milho (sem o líquido),1 lata de leite (medida da lata de milho),1 lata de açúcar (medida da lata de milho),1 lata de flocão de milho,1/2 lata de óleo de soja,3 ovos inteiros,1 colher (sopa) de fermento em pó,margarina para untar,farinha de trigo para untar</div>
