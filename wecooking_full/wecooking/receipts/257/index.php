		...
		<div class="content" style="margin-top: 5vh">
			<div class="inicio">
				<div class="images">
					...
					<div class="add-photo">,bolo(1).png,bolo.png</div>
					<i class="fa-solid fa-chevron-right"></i>
				</div>
				<div class="receipt-info">
					<div class="title">Bolo de Chocolate</div>
			...
			<div class="ingredientes">
				...
				<div id="ingrs">
					<div class="ingrs">,1 xícara (chá) de achocolatado ou chocolate em pó,1 xícara (chá) de açúcar,2 xícaras (chá) de trigo peneirado,1 xícara (chá) de óleo,1 xícara (chá) de leite,2 ovos,1 colher (sopa) de fermento em pó</div>
					<div class="ingrs-cover">,1 colher (sopa) de margarina,3 colheres (sopa) de achocolatado ou chocolate em pó,3 colheres de açúcar,1 xícara (chá) de leite</div>
					<div class="ingrs-fill"></div>
				</div>
			</div>
			<div class="modo-de-preparo">
				<div class="title-preparo">Modo de preparo:</div>
				<div id="preparos">
					<div class="preparo">/Unte uma forma de buraco pequena com margarina e trigo/Reserve. /Bata no liquidificador, o óleo, o leite e o ovo. /Acrescente o trigo, o açúcar e o achocolatado. /Bata novamente. /Em seguida acrescente o fermento e bata. /Despeje na forma e leve ao forno em temperatura média por cerca de 35 minutos. </div>
					<div class="preparo-cover">/Em uma panela coloque no fogo médio a margarina para derreter. /Assim que derreter coloque o açúcar e em seguida o achocolatado, por último acrescente o leite. /Mexa de vez em quando para não gastar, espere engrossar um pouco e despeje ainda quente no bolo.</div>
					<div class="preparo-fill"></div>
				</div>
			</div>
			<div class="comments">
