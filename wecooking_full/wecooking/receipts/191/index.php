		...
		<div class="content" style="margin-top: 5vh">
			<div class="inicio">
				<div class="images">
					...
					<div class="add-photo">,bannercupons.png,Cade A LIVE.png,Diagrama de caso de uso - Diagrama de caso de uso.png</div>
					<i class="fa-solid fa-chevron-right"></i>
				</div>
				<div class="receipt-info">
					<div class="title">torta</div>
					<div class="tempo">Tempo de preparo: 32 minutos</div>
