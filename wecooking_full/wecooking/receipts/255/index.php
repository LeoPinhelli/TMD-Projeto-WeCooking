		...
		<div class="content" style="margin-top: 5vh">
			<div class="inicio">
				<div class="images">
					...
					<div class="add-photo">,torta_alema(1).png,torta_alema.png</div>
					<i class="fa-solid fa-chevron-right"></i>
				</div>
				<div class="receipt-info">
					<div class="title">Torta Alemã</div>
					<div class="tempo">Tempo de preparo: 20 minutos</div>
			...
			<div class="ingredientes">
				...
				<div id="ingrs">
					<div class="ingrs">,200 g de manteiga sem sal,1 xícara (chá) de açúcar,1 lata de creme de leite sem soro,1 pacote de bolacha maisena,leite o bastante para molhar a bolacha,1 lata de leite condensado sabor chocolate (ou cobertura de sorvete)</div>
