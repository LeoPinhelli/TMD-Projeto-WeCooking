...
<html lang="pt">
	<head>
		...
		<title>Torta de Banana (Banoffe)</title>
		...
		<div class="content" style="margin-top: 5vh">
			<div class="inicio">
				<div class="images">
					...
					<div class="add-photo">,torta_banana(1).png,torta_banana.png</div>
					<i class="fa-solid fa-chevron-right"></i>
				</div>
				<div class="receipt-info">
					<div class="title">Torta de Banana (Banoffe)</div>
					<div class="tempo">Tempo de preparo: 30 minutos</div>
			...
			<div class="ingredientes">
				...
				<div id="ingrs">
					<div class="ingrs">,400 g de doce de leite,10 bananas cortadas em rodelas,400 g de nata (chantilly se preferir),1 pacote de biscoito maizena triturado (tipo farinha bem fininho),200 g de margarina culinária,1 colher de chá de canela em pó para polvilhar</div>
			...
			<div class="modo-de-preparo">
				...
				<div id="preparos">
					<div class="preparo">/Misture o biscoito triturado com a margarina culinária, com a ponta dos dedos, até formar uma massa lisa./Forre o fundo de uma forma de abrir (fundo falso), e asse por apenas 10 minutos, em forno preaquecido a 180°C./Retire e deixe a massa esfriar./Coloque o doce de leite sobre a massa já fria e alise para ficar plano./Pique as bananas em rodelas, e distribua-as sobre o doce de leite. /Coloque a nata por cima (se preferir, pode batê-la para deixar em ponto de chantilly), e alise. /Pegue uma peneira pequena, e espalhe a canela por cima passando-a pela peneira, para que pulverize melhor por toda a torta. /Deixe na geladeira por 3 horas antes de desenformar</div>
