		...
		<div class="content" style="margin-top: 5vh">
			<div class="inicio">
				<div class="images">
					...
					<div class="add-photo">,BOLOlimao2.jpeg,BOLOlimao1.jpg</div>
			...
			<div class="ingredientes">
				...
				<div id="ingrs">
					<div class="ingrs">,4 ovos,1/2 copo de óleo,</div>
			...
			<div class="modo-de-preparo">
				...
				<div id="preparos">
					<div class="preparo">/Bata no liquidificador os ovos inteiros, o óleo e o açúcar (bem batidos). /Coloque a gelatina e continue batendo até dissolver. /</div>
