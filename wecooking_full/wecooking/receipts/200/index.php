...
<html lang="pt">
		...
		<div class="content" style="margin-top: 5vh">
			<div class="inicio">
				<div class="images">
					...
					<div class="add-photo">,Screenshot_2.png</div>
					<i class="fa-solid fa-chevron-right"></i>
				</div>
				<div class="receipt-info">
					<div class="title">pave</div>
			...
			<div class="ingredientes">
				...
				<div id="ingrs">
					<div class="ingrs">,pave,pave,pave</div>
			...
			<div class="modo-de-preparo">
				...
				<div id="preparos">
					<div class="preparo">/pave/pave/pave</div>
	...
	<script type="text/javascript" src="../../js/similar.js">// Receitas parecidas</script>
	<script>
		let usuario = "";
