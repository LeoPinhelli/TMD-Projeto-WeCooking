		...
		<div class="content" style="margin-top: 5vh">
			<div class="inicio">
				<div class="images">
					...
					<div class="add-photo">' . $row['receipt_images'] . '</div>
			...
			<div class="ingredientes">
				...
				<div id="ingrs">
					...
					<div class="ingrs-cover">' . $row['receipt_ingredients_coverage'] . '</div>
					<div class="ingrs-fill">' . $row['receipt_ingredients_filling'] . '</div>
				</div>
			</div>
			<div class="modo-de-preparo">
				...
				<div id="preparos">
					...
					<div class="preparo-cover">' . $row['receipt_coverage_preparation'] . '</div>
					<div class="preparo-fill">' . $row['receipt_filling_preparation'] . '</div>
				</div>
			</div>
			<div class="comments">
