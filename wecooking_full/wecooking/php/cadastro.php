...
$sql = "INSERT INTO users (user_name, user_email, user_password, user_status, user_admin) VALUES ('$nome', '$email', '$encryptedPassword', '1', '0')";
...
try {
	...
	$mail->isHTML(true);
	$mail->Subject = 'We Cooking | Ativar Conta';
	$mail->Body = '
		<html lang="pt">
		<head>
			...
			<div style="height: 100%;width: 100%;display: flex;flex-direction: column;align-items: center;justify-content: center;">
				<div style="height: auto;width: 40vw;align-items: center;">
					...
					<div style="padding: 3vh;">
						...
						<a href="https://wecooking.online/ativar_conta.php#' . $email . '" target="_blank" rel="noopener noreferrer" class="button-link">
							...
							text-align: center;
							cursor: pointer;
							margin: 3vh 0;">Ativar conta</button>
						</a>
						<div class="link">
							<p style="margin: 0">Caso o botão não funcione, utilize o link abaixo:</p>
							<a href="https://wecooking.online/ativar_conta.php#' . $email . '" target="_blank" rel="noopener noreferrer">
							http://wecooking.online/ativar_conta.php#' . $encryptedEmail . '
							</a>
						</div>
						<p class="ignore">Se você não solicitou a criação de uma conta, por favor ignore esse e-mail.</p>
