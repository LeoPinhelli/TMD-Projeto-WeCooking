...
<html lang="pt">
	<head>
		...
		<title>Palha italiana(user)</title>
		...
		<div class="content" style="margin-top: 5vh">
			<div class="inicio">
				<div class="images" style="flex-direction: column">
					<div class="add-photo" style="flex-direction: row; gap: 1.2vw">,imagem_2023-11-16_215114108.png,imagem_2023-11-16_215118862.png</div>
				</div>
				<div class="receipt-info" style="height: 22vh;">
					<div class="title">Palha italiana(user)</div>
			...
			<div style="display: flex; flex-direction: row; width: 100%; gap: 8vw">
				<div class="ingredientes" style="margin-top: 10vh">
					...
					<div id="ingrs">
						<div class="ingrs">1,lata,de,leite,condensado,8,colheres,(sopa),de,chocolate,em,pó,1/2,colher,(sopa),de,margarina,1,pacote,de,biscoito,maisena,</div>
					</div>
				</div>
				<div class="modo-de-preparo" style="margin-top: 10vh">
					<div class="title-preparo">Modo de preparo:</div>
					<div id="preparos">
						<div class="preparo">Pique,o,biscoito,em,pedacinhos,pequenos,e,reserve.,Com,o,leite,condensado,,a,margarina,e,o,chocolate,em,pó,,faça,um,brigadeiro.,Assim,que,o,brigadeiro,começar,a,soltar,do,fundo,da,panela,,misture,o,biscoito,picado,até,formar,uma,massa,,retire,do,fogo.,</div>
					</div>
				</div>
			</div>
		</div>
