		...
		<div class="content" style="margin-top: 5vh">
			<div class="inicio">
				<div class="images" style="flex-direction: column">
					<div class="add-photo" style="flex-direction: row; gap: 1.2vw">,bolo_limao.png,bolo_milho(1).png,bolo_milho.png</div>
				</div>
				<div class="receipt-info" style="height: 22vh;">
					<div class="title">bolo de coco(user)</div>
					<div class="tempo">Tempo de preparo: 12 minutos</div>
