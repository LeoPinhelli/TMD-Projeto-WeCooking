		...
		<div class="content" style="margin-top: 5vh">
			<div class="inicio">
				<div class="images" style="flex-direction: column">
					<div class="add-photo" style="flex-direction: row; gap: 1.2vw">,imagem_2023-11-16_225149385.png,imagem_2023-11-16_225153254.png</div>
				</div>
			...
			<div style="display: flex; flex-direction: row; width: 100%; gap: 8vw">
				<div class="ingredientes" style="margin-top: 10vh">
					...
					<div id="ingrs">
						<div class="ingrs">1 xícara de leite quente,3 xícaras de farinha de trigo,2 xícaras de açúcar,3 gemas,3 claras em neve,1 colher de fermento em pó químico</div>
					</div>
				</div>
