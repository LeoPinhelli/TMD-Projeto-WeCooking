		...
		<div class="content" style="margin-top: 5vh">
			<div class="inicio">
				<div class="images" style="flex-direction: column">
					<div class="add-photo" style="flex-direction: row; gap: 1.2vw">,imagem_2023-11-16_225226258.png</div>
				</div>
				<div class="receipt-info" style="height: 22vh;">
					<div class="title">Broa de fubá(user)</div>
					<div class="tempo">Tempo de preparo: 45 minutos</div>
			...
			<div style="display: flex; flex-direction: row; width: 100%; gap: 8vw">
				<div class="ingredientes" style="margin-top: 10vh">
					...
					<div id="ingrs">
						<div class="ingrs">3 ovos inteiros,1/2 copo (americano) de óleo,1 copo (tipo requeijão) de açúcar,2 copos (tipo requeijão) de fubá,1 copo (tipo requeijão) de leite,1 colher (sopa) de fermento em pó,1 pitada de sal,Queijo a gosto (ou coco ralado)</div>
					</div>
				</div>
				<div class="modo-de-preparo" style="margin-top: 10vh">
					<div class="title-preparo">Modo de preparo:</div>
					<div id="preparos">
						<div class="preparo">Bater todos os ingredientes no liquidificador.,Levar ao forno pré - aquecido por 30 a 40 minutos, em forma untada e enfarinhada</div>
					</div>
				</div>
			</div>
		</div>
