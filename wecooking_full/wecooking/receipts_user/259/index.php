		...
		<div class="content" style="margin-top: 5vh">
			<div class="inicio">
				<div class="images" style="flex-direction: column">
					<div class="add-photo" style="flex-direction: row; gap: 1.2vw">,BOLOlimao1.jpg,BOLOlimao2.jpeg</div>
				</div>
			...
			<div style="display: flex; flex-direction: row; width: 100%; gap: 8vw">
				<div class="ingredientes" style="margin-top: 10vh">
					...
					<div id="ingrs">
						<div class="ingrs">Massa,4 ovos,1/2 copo de óleo,2 copos de açúcar não muito cheios,1 copo de leite,1 caixa de gelatina de limão,2 xícaras de farinha de trigo,1 colher de sopa de Fermento em pó,Cobertura e Recheio,1 lata de leite condensado,Suco de 3 limões</div>
					</div>
				</div>
