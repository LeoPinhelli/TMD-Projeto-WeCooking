		...
		<div class="content" style="margin-top: 5vh">
			<div class="inicio">
				<div class="images" style="flex-direction: column">
					<div class="add-photo" style="flex-direction: row; gap: 1.2vw">,imagem_2023-11-16_215532437.png,imagem_2023-11-16_215538601.png</div>
				</div>
				<div class="receipt-info" style="height: 22vh;">
					<div class="title">Cupcake(user)</div>
					<div class="tempo">Tempo de preparo: 35 minutos</div>
			...
			<div style="display: flex; flex-direction: row; width: 100%; gap: 8vw">
				<div class="ingredientes" style="margin-top: 10vh">
					...
					<div id="ingrs">
						<div class="ingrs">3,ovos,1,xícara,(chá),de,oléo,1/2,xícara,(chá),de,leite,1,1/2,xícaras,(chá),de,açúcar,2,xícara,(chá),farinha,de,trigo,1/2,xícara,(chá),de,chocolate,1,colher,(sopa),de,fermento,em,pó</div>
					</div>
				</div>
				<div class="modo-de-preparo" style="margin-top: 10vh">
					<div class="title-preparo">Modo de preparo:</div>
					<div id="preparos">
						<div class="preparo">Bater,os,ovos,,oléo,,o,leite,e,o,açúcar,no,liquidificador,por,5,minutos.,Em,uma,vasilha,misturar,a,farinha,,o,chocolate,e,o,fermento,,misturar,bem,e,adicionar,o,líquido,do,liquidificador,,mexer,bem,e,colocar,em,forminhas.</div>
					</div>
				</div>
			</div>
		</div>
