...
<html lang="pt">
	<head>
		...
		<title>teste laranja(user)</title>
		...
		<div class="content" style="margin-top: 5vh">
			<div class="inicio">
				<div class="images" style="flex-direction: column">
					<div class="add-photo" style="flex-direction: row; gap: 1.2vw">,bolo_laranja.png</div>
				</div>
				<div class="receipt-info" style="height: 22vh;">
					<div class="title">teste laranja(user)</div>
					<div class="tempo">Tempo de preparo: 44 minutos</div>
			...
			<div style="display: flex; flex-direction: row; width: 100%; gap: 8vw">
				<div class="ingredientes" style="margin-top: 10vh">
					...
					<div id="ingrs">
						<div class="ingrs">2 laranjas,2 limoes,3 macas</div>
					</div>
				</div>
				<div class="modo-de-preparo" style="margin-top: 10vh">
					<div class="title-preparo">Modo de preparo:</div>
					<div id="preparos">
						<div class="preparo">bata os limoes,bata nas laranjas</div>
					</div>
				</div>
			</div>
		</div>
