		...
		<div class="content" style="margin-top: 5vh">
			<div class="inicio">
				<div class="images" style="flex-direction: column">
					<div class="add-photo" style="flex-direction: row; gap: 1.2vw">,FyS2lCrWAAAgxm7.png</div>
				</div>
				<div class="receipt-info" style="height: 22vh;">
					<div class="title">follen(user)</div>
					<div class="tempo">Tempo de preparo: 43 minutos</div>
