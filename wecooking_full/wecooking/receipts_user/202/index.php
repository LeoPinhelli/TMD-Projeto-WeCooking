		...
		<div class="content" style="margin-top: 5vh">
			<div class="inicio">
				<div class="images" style="flex-direction: column">
					<div class="add-photo" style="flex-direction: row; gap: 1.2vw">,uma-pintura-de-um-lago-de-montanha-com-uma-montanha-ao-fundo_188544-9126.jpg,printReceipt-bg.png,image (1).png</div>
				</div>
				<div class="receipt-info" style="height: 22vh;">
					<div class="title">YAKISOBAAAA(user)</div>
					<div class="tempo">Tempo de preparo: 5322648 minutos</div>
			...
			<div style="display: flex; flex-direction: row; width: 100%; gap: 8vw">
				<div class="ingredientes" style="margin-top: 10vh">
					...
					<div id="ingrs">
						<div class="ingrs">yaki,soba,yakisoba,ya,ki,so,ba,</div>
					</div>
				</div>
				<div class="modo-de-preparo" style="margin-top: 10vh">
					<div class="title-preparo">Modo de preparo:</div>
					<div id="preparos">
						<div class="preparo">pega,o,ya,com,o,ki,=,yaki.,so,+ba,=,soba,yaki+soba,=,yakisoba</div>
					</div>
				</div>
			</div>
		</div>
