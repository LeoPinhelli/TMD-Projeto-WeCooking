		...
		<div class="content" style="margin-top: 5vh">
			<div class="inicio">
				<div class="images" style="flex-direction: column">
					<div class="add-photo" style="flex-direction: row; gap: 1.2vw">,Bolos especiais.png,Design sem nome.png,Bolos especiais.png</div>
				</div>
				<div class="receipt-info" style="height: 22vh;">
					<div class="title">torta(user)</div>
