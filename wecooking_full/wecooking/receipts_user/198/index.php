...
<head>
	...
	<title>Torta de Morango(user)</title>
		...
		<div class="content" style="margin-top: 5vh">
			<div class="inicio">
				<div class="images" style="flex-direction: column">
					<div class="add-photo" style="flex-direction: row; gap: 1.2vw">,bolo(1).png,torta.png,torta1.png
					</div>
				</div>
				<div class="receipt-info" style="height: 22vh;">
					<div class="title">Torta de Morango(user)</div>
