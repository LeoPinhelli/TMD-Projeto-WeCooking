...
<html lang="pt">
	<head>
		...
		<title>Pudim de Leite Condensado(user)</title>
		...
		<div class="content" style="margin-top: 5vh">
			<div class="inicio">
				<div class="images" style="flex-direction: column">
					<div class="add-photo" style="flex-direction: row; gap: 1.2vw">,imagem_2023-11-16_215257552.png,imagem_2023-11-16_215302873.png</div>
				</div>
				<div class="receipt-info" style="height: 22vh;">
					<div class="title">Pudim de Leite Condensado(user)</div>
			...
			<div style="display: flex; flex-direction: row; width: 100%; gap: 8vw">
				<div class="ingredientes" style="margin-top: 10vh">
					...
					<div id="ingrs">
						<div class="ingrs">Massa:,1,lata,de,leite,condensado,1,lata,de,leite,(medida,da,lata,de,leite,condensado),3,ovos,inteiros,Calda:,1,xícara,(chá),de,açúcar,1/2,xícara,de,água,</div>
					</div>
				</div>
				<div class="modo-de-preparo" style="margin-top: 10vh">
					<div class="title-preparo">Modo de preparo:</div>
					<div id="preparos">
						<div class="preparo">Massa:,Primeiro,,bata,bem,os,ovos,no,liquidificador.,Acrescente,o,leite,condensado,e,o,leite,,e,bata,novamente.,Calda:,Derreta,o,açúcar,na,panela,até,ficar,moreno,,acrescente,a,água,e,deixe,engrossar.,Coloque,em,uma,forma,redonda,e,despeje,a,massa,do,pudim,por,cima.,Asse,em,forno,médio,por,45,minutos,,com,a,assadeira,redonda,dentro,de,uma,maior,com,água.,Espete,um,garfo,para,ver,se,está,bem,assado.,Deixe,esfriar,e,desenforme.</div>
					</div>
				</div>
			</div>
		</div>
