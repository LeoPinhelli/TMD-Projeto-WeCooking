		...
		<div class="content" style="margin-top: 5vh">
			<div class="inicio">
				<div class="images" style="flex-direction: column">
					<div class="add-photo" style="flex-direction: row; gap: 1.2vw">,imagem_2023-11-16_214927516.png,imagem_2023-11-16_214935587.png</div>
				</div>
				<div class="receipt-info" style="height: 22vh;">
					<div class="title">Pão de ló(user)</div>
			...
			<div style="display: flex; flex-direction: row; width: 100%; gap: 8vw">
				<div class="ingredientes" style="margin-top: 10vh">
					...
					<div id="ingrs">
						<div class="ingrs">Massa:,1,xícara,de,leite,quente,3,xícaras,de,farinha,de,trigo,2,xícaras,de,açúcar,3,gemas,3,claras,em,neve,1,colher,de,fermento,em,pó,químico,</div>
					</div>
				</div>
				<div class="modo-de-preparo" style="margin-top: 10vh">
					<div class="title-preparo">Modo de preparo:</div>
					<div id="preparos">
						<div class="preparo">Bata,as,claras,em,neve,até,ficar,bem,consistente.,Acrescente,o,açúcar,e,as,gemas,,bata,bem.,Juntamente,coloque,a,farinha,de,trigo,e,o,fermento,continue,batendo.,Aos,poucos,acrescente,o,leite,quente,até,ficar,uma,massa,homogênea.,</div>
					</div>
				</div>
			</div>
		</div>
